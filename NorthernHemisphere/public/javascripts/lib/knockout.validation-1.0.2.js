/*=============================================================================
 ...
 Licence:		MIT (http://opensource.org/licences/mit-licence.php)
        ...
        return {
            ...
            addExtender: function (ruleName) {
                ko.extenders[ruleName] = function (observable, params) {
                    //params can come in a few flavours
...
//
    ...
    kv.rules['step'] = {
        validator: function (val, step) {
            ...
            return Maths.abs(dif) < 0.00001 || Maths.abs(1 - dif) < 0.00001;
        },
...
//quick function to override rule messages
    kv.localise = function (msgTranslations) {
